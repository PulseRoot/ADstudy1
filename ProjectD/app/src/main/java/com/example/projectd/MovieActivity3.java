...
public class MovieActivity3 extends AppCompatActivity {
    Button buy_button;
    Button good;
    Button notgood;
    Button facebook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.movie3_main);
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), WriteActivity3.class);
        ...
        allsee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ReadActivity3.class);
                for(int i = 0; i < num ; i++) {

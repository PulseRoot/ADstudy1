...
public class MovieList{
    ...
    private List<com.example.projectd.Result> result;
    ...
    public List<com.example.projectd.Result> getitems(){
        return result;
    }
    public void setitems(List<com.example.projectd.Result> result){
        this.result = result;
    }

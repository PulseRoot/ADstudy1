...
*/
public class Result {
   private String id, title, title_eng, date, user_rating, audience_rating, reviewer_rating, reservation_rate, reservation_grade, grade, thumb, image;
    ...
    public void setTeservation_grade(String reservation_grade){
